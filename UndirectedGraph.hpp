...
public:
   ...
   */
    ...
    UndirectedGraph(int numVertices, char rep){
        n=numVertices;
        ch = rep;
        if (rep== 'm' || rep=='M')
        {
            udgm.create(numVertices);
        }
        else
        {
            udgl.create(numVertices);
        }
    };
    /*
    * Function: indegree
    ...
    */
    int indegree(int i){
        if (ch== 'm' || ch=='M')
        {
            return udgm.indegree(i);
        }
        else{
            return udgl.indegree(i);
        }
    };
    /*
    * Function: outdegree
    ...
    */
    int outdegree(int j){
        if (ch== 'm' || ch=='M')
        {
            return udgm.outdegree(j);
        }
        else{
            return udgl.outdegree(j);
        }
    };
    ...
    */
    bool edgeExists(int i, int j){
        if (ch== 'm' || ch=='M')
        {
            return udgm.edgeExists(i,j);
        }
        else{
            return udgl.edgeExists(i,j);
        }
    };
    /*
    * Function: edges
    ...
    */
    int vertices(){
        if (ch== 'm' || ch=='M')
        {
            return udgm.vertices();
        }
        else{
            return udgl.vertices();
        }
    };
    /*
    * Function add:
    ...
    */
    void remove(int i, int j){
        if (ch== 'm' || ch=='M')
        {
            return udgm.remove(i,j);
        }
        else{
            return udgl.remove(i,j);
        }
    };
    /*
    * Function dfs:
